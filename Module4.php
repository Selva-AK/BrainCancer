 ...
 if(isset($_POST["ins"]))
 {
  ...
  { 
   ...
   {	
	...
	$sql="select * from module_name4 where Id='".$Id."'";		
	...
	else
	{
	 #echo $Photo;
	 #insert place
	 $sql="INSERT INTO module_name4(Id,ColumnName1,ColumnName2,ColumnName3,ColumnName4,ColumnName5)VALUES('$_POST[Id]','$_POST[ColumnName1]','$_POST[ColumnName2]','$_POST[ColumnName3]','$_POST[ColumnName4]','$_POST[ColumnName5]')";
 ...
 if(isset($_POST["up"]))
 {
  ...
  else
  {
   ...
   {	
	...
	if($result->num_rows >0)
	{
	  $sql="update module_name4 set ColumnName1='".$ColumnName1."',ColumnName2='".$ColumnName2."',ColumnName3='".$ColumnName3."',ColumnName4='".$ColumnName4."', ColumnName5='".$ColumnName5."' where Id='".$Id."'";
	  if($conn->query($sql)===true)
	  {
		#echo "record updated";
 ...
 if(isset($_POST["del"]))
 {
  ...
  else
  {
   if(empty($_POST["Id"]))
	...
	if($result->num_rows >0)
	{
	$sql="delete from module_name4 where Id='".$Id."'";
	if($conn->query($sql)===true)
	{	 
		...
		<div class="col-sm-4"></div>
			...
			<br>
				<div class=" " style="background-color: #3b5998;">
					<h5 class="card-header card-title  text-white text-center" style="font-family: arial">Classification Models</h5>
				</div>
				<form method="post" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
					...
					<div class="form-group">
					<div class="input-group">
						<label class="col-form-label mr-1 col-3" for="name">Samples</label>
					...
					<div class="form-group">
					<div class="input-group">
						<label class="col-form-label mr-1 col-3" for="name">Classifiers</label>
					...
					<div class="form-group">
					<div class="input-group">
						<label class="col-form-label mr-1 col-3" for="name">F-score</label>
