 ...
 if(isset($_POST["ins"]))
 {
  ...
  { 
   ...
   {	
	...
	$sql="select * from module_name5 where Id='".$Id."'";		
	...
	else
	{
	 #echo $Photo;
	 #insert place
	 $sql="INSERT INTO module_name5(Id,ColumnName1,ColumnName2,ColumnName3,ColumnName4,ColumnName5)VALUES('$_POST[Id]','$_POST[ColumnName1]','$_POST[ColumnName2]','$_POST[ColumnName3]','$_POST[ColumnName4]','$_POST[ColumnName5]')";
 ...
 if(isset($_POST["up"]))
 {
  ...
  else
  {
   ...
   {	
	...
	if($result->num_rows >0)
	{
	  $sql="update module_name5 set ColumnName1='".$ColumnName1."',ColumnName2='".$ColumnName2."',ColumnName3='".$ColumnName3."',ColumnName4='".$ColumnName4."', ColumnName5='".$ColumnName5."' where Id='".$Id."'";
	  if($conn->query($sql)===true)
	  {
		#echo "record updated";
 ...
 if(isset($_POST["del"]))
 {
  ...
  else
  {
   if(empty($_POST["Id"]))
	...
	if($result->num_rows >0)
	{
	$sql="delete from module_name5 where Id='".$Id."'";
	if($conn->query($sql)===true)
	{	 
		...
		<div class="col-sm-4"></div>
			...
			<br>
				<div class=" " style="background-color: #3b5998;">
					<h5 class="card-header card-title  text-white text-center" style="font-family: arial">Tumor Prediction</h5>
				</div>
				<form method="post" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
					...
					<div class="form-group">
					<div class="input-group">
						<label class="col-form-label mr-1 col-3" for="name">Features</label>
					...
					<div class="form-group">
					<div class="input-group">
						<label class="col-form-label mr-1 col-3" for="name">Case1</label>
					...
					<div class="form-group">
					<div class="input-group">
						<label class="col-form-label mr-1 col-3" for="name">Case2</label>
					...
					<div class="form-group">
					<div class="input-group">
						<label class="col-form-label mr-1 col-3" for="name">Case3</label>
					...
					<div class="form-group">
					<div class="input-group">
						<label class="col-form-label mr-1 col-3" for="name">Case4</label>
					...
					<div class="form-group">
					<div class="input-group">
						<label class="col-form-label mr-1 col-3" for="name">Case5</label>
						<input type="text" value="<?php if(isset($ColumnName5)) echo $ColumnName5;?>" id="ColumnName5" class="form-control col-9" name="ColumnName5" placeholder="" autocomplete="off">
						<span class="error">* <?php echo $ColumnName5Err;?></span>
					</div>
					</div>
					...
					<div class="form-group">
					<div class="input-group">
						<label class="col-form-label mr-1 col-3" for="name">Target</label>
					...
					<div class="form-group">
					<div class="input-group">
						<label class="col-form-label mr-1 col-3" for="name">Treatment</label>
...
<?php 
 ...
 function show()
 {
  ...
  { 
   $sql="select * from module_name5";
   echo '<table border="1" cellspacing="0" class="table-responsive" cellpadding="5" style="color:green"> 
        <tr> 
			<td><b> <font face="Arial">Id</font> </td> 
			<td><b> <font face="Arial">Features</font> </td>	
			<td><b> <font face="Arial">Case1</font> </td>	
			<td><b> <font face="Arial">Case2</font> </td>	
			<td><b> <font face="Arial">Case3</font> </td>	
			<td><b> <font face="Arial">Case4</font> </td>
			<td><b> <font face="Arial">Case5</font> </td>	
			<td><b> <font face="Arial">Target</font> </td>
			<td><b> <font face="Arial">Treatment</font> </td>	
        </tr>
	   ';	  
   $result=$conn->query($sql);
