 ...
 if(isset($_POST["ins"]))
 {
  ...
  { 
   ...
   {	
	...
	$sql="select * from module_name3 where Id='".$Id."'";		
	...
	else
	{
	 #echo $Photo;
	 #insert place
	 $sql="INSERT INTO module_name3(Id,ColumnName1,ColumnName2,ColumnName3,ColumnName4,ColumnName5)VALUES('$_POST[Id]','$_POST[ColumnName1]','$_POST[ColumnName2]','$_POST[ColumnName3]','$_POST[ColumnName4]','$_POST[ColumnName5]')";
 ...
 if(isset($_POST["up"]))
 {
  ...
  else
  {
   ...
   {	
	...
	if($result->num_rows >0)
	{
	  $sql="update module_name3 set ColumnName1='".$ColumnName1."',ColumnName2='".$ColumnName2."',ColumnName3='".$ColumnName3."',ColumnName4='".$ColumnName4."', ColumnName5='".$ColumnName5."' where Id='".$Id."'";
	  if($conn->query($sql)===true)
	  {
		#echo "record updated";
 ...
 if(isset($_POST["del"]))
 {
  ...
  else
  {
   if(empty($_POST["Id"]))
	...
	if($result->num_rows >0)
	{
	$sql="delete from module_name3 where Id='".$Id."'";
	if($conn->query($sql)===true)
	{	 
		...
		<div class="col-sm-4"></div>
			...
			<br>
				<div class=" " style="background-color: #3b5998;">
					<h5 class="card-header card-title  text-white text-center" style="font-family: arial">Surveillance Epidemiology</h5>
				</div>
				<form method="post" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
					...
					<div class="form-group">
					<div class="input-group">
						<label class="col-form-label mr-1 col-3" for="name">Sensitivity</label>
					...
					<div class="form-group">
					<div class="input-group">
						<label class="col-form-label mr-1 col-3" for="name">Positives</label>
					...
					<div class="form-group">
					<div class="input-group">
						<label class="col-form-label mr-1 col-3" for="name">Negatives</label>
					...
					<div class="form-group">
					<div class="input-group">
						<label class="col-form-label mr-1 col-3" for="name">Precision</label>
					...
					<div class="form-group">
					<div class="input-group">
						<label class="col-form-label mr-1 col-3" for="name">Predicting Malignancy</label>
...
<?php 
 ...
 function show()
 {
  ...
  { 
   $sql="select * from module_name3";
   echo '<table border="1" cellspacing="0" class="table-responsive" cellpadding="5" style="color:green"> 
        <tr> 
			<td><b> <font face="Arial">Id</font> </td> 
			<td><b> <font face="Arial">Sensitivity</font> </td>	
			<td><b> <font face="Arial">Positives</font> </td>	
			<td><b> <font face="Arial">Negatives</font> </td>	
			<td><b> <font face="Arial">Precision</font> </td>	
			<td><b> <font face="Arial">Predicting Malignancy</font> </td>	
        </tr>
	   ';	  
   $result=$conn->query($sql);
